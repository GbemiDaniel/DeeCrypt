...
export type Project = PreviewItem & {
  ...
  // ✅ NEW FIELD FOR DEVICE-AWARE MODAL GALLERY
  gallery?: {
    desktop: string[];
    mobile?: string[];
  };
...
export const projects: Project[] = [
  {
    id: "thrifty",
    title: "Thrifty",
    subtitle: "Minimal ecommerce experience for modern fashion brands",
    badge: "COLLAB",

    // Used for the Carousel Cover
    previewImage: "/projects/thrifty-ecommerce-store/thrifty-landing-page.png",

    // Used for the inside of the Modal
    gallery: {
      desktop: [
        "/projects/thrifty-ecommerce-store/thrifty-landing-page.png"
      ],
      mobile: [
        "/projects/thrifty-ecommerce-store/thrifty-landing-page-mobile.png"
      ],
    },
  ...
  },
  {
    ...
    gallery: {
      desktop: [
        "/projects/designer-portfolio/designer-portfolio-landing-page.png"
      ],
      mobile: [
        "/projects/designer-portfolio/designer-portfolio-landing-page-mobile.png"
      ],
    },
  ...
  },
  {
    ...
    subtitle: "Cybersecurity identity platform for a security researcher",
    badge: "COLLAB",
    previewImage: "/projects/pentester-porfolio/pentester-portfolio-landing-page.png",
    ...
    gallery: {
      ...
      mobile: [
        "/projects/pentester-porfolio/pentester-portfolio-landing-page-mobile.png"
      ],
    },
  ...
  },
  {
    id: "creator-os",
    title: "Creator OS",
    subtitle: "Interactive digital identity system for showcasing projects, writing, and experimentation",
    badge: "CASE STUDY",
  ...
  },
  {
    id: "skillz-bloom",
    title: "Skillz Bloom",
    subtitle: "Student growth platform focused on daily learning and skill development",
    badge: "TEAM PROJECT",
    ...
    gallery: {
      desktop: [
        "/preview/SkillzBloom.png"
      ],
      mobile: [
        "/preview/skillzBloom-mobile.png"
      ],
    },
